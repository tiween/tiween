...
area: apps/strapi
title: apps/strapi
description: Strapi v5 backend decomposed into nine plugins
verified: 2026-08-12
sources: [apps/strapi/src/plugins/, _bmad-output/project-planning-artifacts/architecture.md]
---
...
[entity-properties-vestigial](../entity-properties-vestigial.md).
...
`yarn workspace @tiween/admin test:integration` — [test-layout](../test-layout.md).

**What's surprising.**

- Cross-plugin calls go through `services/public-api.ts` only, and nothing enforces it
  — [plugin-dependency-rules](../plugin-dependency-rules.md)
