module.exports = ({ env }) => ({
  ...
  upload: {
    config: {
      ...
      providerOptions: {
        publicKey: env('IMAGE_KIT_PUBLIC_KEY', 'public_/WxWzg8xq8JvIqM0E4vVMNFr5Pk='),
        privateKey: env('IMAGE_KIT_PRIVATE_KEY', 'private_I9GkInBCLKy/h7hSfcNQAJKkeTs='),
        urlEndpoint: env('IMAGE_KIT_URL_ENDPOINT', 'https://ik.imagekit.io/bc2xslzyt/tiween-development'),  // Example: https://ik.imagekit.io/username
