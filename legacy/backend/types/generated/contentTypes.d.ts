...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    iso_3166_code: Schema.Attribute.String &
...
export interface ApiCreativeWorkCreativeWork
  ...
  attributes: {
    ...
    facts: Schema.Attribute.Component<'common.remarkable-facts', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    production_companies: Schema.Attribute.Relation<
      'oneToMany',
      'api::production-company.production-company'
    >;
    production_countries: Schema.Attribute.Relation<
      'oneToMany',
      'api::country.country'
    >;
    publishedAt: Schema.Attribute.DateTime;
    ...
    type: Schema.Attribute.Enumeration<['SHORT_MOVIE', 'PLAY', 'DANSE']> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
...
export interface ApiEventGroupEventGroup extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Hero: Schema.Attribute.Component<'common.hero-display', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-group.event-group'
    > &
      Schema.Attribute.Private;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    feminine: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiMediumMedium extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['VENUE', 'CHANNEL', 'TV_SHOW', 'ONLINE']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'VENUE'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMoviemetaMoviemeta extends Struct.CollectionTypeSchema {
  collectionName: 'moviemetas';
  info: {
    displayName: 'Moviemeta';
    pluralName: 'moviemetas';
    singularName: 'moviemeta';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    originalTitle: Schema.Attribute.String;
    overridden_poster: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    remote: Schema.Attribute.JSON;
    runtime: Schema.Attribute.Integer;
    title: Schema.Attribute.String;
    tmdbid: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProductionCompanyProductionCompany
  extends Struct.CollectionTypeSchema {
  collectionName: 'production_companies';
  info: {
    description: '';
    displayName: 'ProductionCompany';
...
export interface ApiShowtimeShowtime extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    language: Schema.Attribute.Enumeration<
      ['vostfr', 'vo', 'vf', 'vosttn', 'vostang']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'vostfr'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    medium: Schema.Attribute.Relation<'oneToOne', 'api::medium.medium'>;
    moviemeta: Schema.Attribute.Relation<
      'oneToOne',
      'api::moviemeta.moviemeta'
    >;
    ...
    publishedAt: Schema.Attribute.DateTime;
    runtime: Schema.Attribute.Integer;
    tmdbid: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_format: Schema.Attribute.Enumeration<['TWO_D', 'THREE_D']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::event-group.event-group': ApiEventGroupEventGroup;
      'api::event.event': ApiEventEvent;
      'api::job.job': ApiJobJob;
      'api::medium.medium': ApiMediumMedium;
      'api::moviemeta.moviemeta': ApiMoviemetaMoviemeta;
      'api::person.person': ApiPersonPerson;
      'api::production-company.production-company': ApiProductionCompanyProductionCompany;
