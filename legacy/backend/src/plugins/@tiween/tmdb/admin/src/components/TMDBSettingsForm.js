            ...
            <Stack spacing={3}>
              <Field name="apiKey">
                <Stack spacing={1}>
                  ...
                  <FieldInput type="text" value={values.apiKey} onChange={(event) => {
              ...
              <Field name="apiBaseUrl">
                <Stack spacing={1}>
                  ...
                  <FieldInput type="text" value={values.apiBaseUrl} onChange={(event) => {
              ...
              <Field name="imageBaseUrl">
                <Stack spacing={1}>
                  ...
                  <FieldInput type="text" value={values.imageBaseUrl} onChange={(event) => {
