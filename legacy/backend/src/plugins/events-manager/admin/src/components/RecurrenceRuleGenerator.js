...
const RecurrenceRuleGenerator = ({ value = '', onChange = null, startDate }) => {
  ...
  return (
    <Box padding={4} hasRadius shadow="filterShadow">
      ...
      <Stack horizontal spacing={2}>
        ...
        <Select id="endMode" placeholder="Fin" hint="Mode de fin de la répétition" onChange={(value) => {
          setState({ mode: value });
        }}>
