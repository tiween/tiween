...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*CA or fuzzy match on create-agent" exec="{project-root}/_bmad/bmb/workflows/create-agent/workflow.md">[CA] Create a new BMAD agent with best practices and compliance</item>
    <item cmd="*EA or fuzzy match on edit-agent" exec="{project-root}/_bmad/bmb/workflows/edit-agent/workflow.md">[EA] Edit existing BMAD agents while maintaining compliance</item>
